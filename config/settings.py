...
ALLOWED_HOSTS: list[str] = [
    host.strip() for host in str(config("ALLOWED_HOSTS", default="localhost,127.0.0.1")).split(",") if host.strip()
]
...
CSRF_TRUSTED_ORIGINS: list[str] = _parse_csrf_origins(str(config("CSRF_TRUSTED_ORIGINS", default="")))
