...
class TestAccountAPI:
    ...
    def test_patch_account_updates_user_fields(self, auth_api_client: APIClient, user: User) -> None:
...
class TestAdminUserAPI:
    ...
    def test_deactivate_user(self, admin_api_client: APIClient, user: User) -> None:
    ...
    def test_deactivate_self_forbidden(self, admin_api_client: APIClient, admin_user: User) -> None:
    ...
    def test_reactivate_user(self, admin_api_client: APIClient, user: User) -> None:
    ...
    def test_toggle_admin_promotes_user(self, admin_api_client: APIClient, user: User) -> None:
    ...
    def test_toggle_admin_demotes_admin(self, admin_api_client: APIClient, db: Any) -> None:
        """Test toggle-admin demotes an admin to regular user."""
        other_admin = User.objects.create_superuser(username="otheradmin", password="pass123")
    ...
    def test_toggle_admin_self_forbidden(self, admin_api_client: APIClient, admin_user: User) -> None:
    ...
    def test_hard_delete_user(self, admin_api_client: APIClient, user: User) -> None:
    ...
    def test_hard_delete_self_forbidden(self, admin_api_client: APIClient, admin_user: User) -> None:
    ...
    def test_hard_delete_forbidden_for_regular_user(self, auth_api_client: APIClient, admin_user: User) -> None:
        """Test that non-admin users cannot hard-delete."""
        response = auth_api_client.delete(f"/api/admin/users/{admin_user.pk}/hard-delete/")
        assert_that(response.status_code, equal_to(status.HTTP_403_FORBIDDEN))

    def test_set_password(self, admin_api_client: APIClient, user: User) -> None:
    ...
    def test_set_password_too_short(self, admin_api_client: APIClient, user: User) -> None:
    ...
    def test_set_password_missing(self, admin_api_client: APIClient, user: User) -> None:
    ...
    def test_set_password_forbidden_for_regular_user(self, auth_api_client: APIClient, admin_user: User) -> None:
...
class TestCommandApiKeyAuthentication:
    ...
    def test_missing_header_skips_auth(self, mock_key: Any) -> None:
        """Returns None when Authorization header is absent so session auth can run."""
        auth = CommandApiKeyAuthentication()
        request = self._make_request()
        result = auth.authenticate(request)
        assert_that(result, is_(None))
