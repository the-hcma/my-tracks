...
class TestDockerEntrypoint:
    ...
    def test_entrypoint_exists(self) -> None:
        entrypoint = Path(__file__).resolve().parent.parent.parent / "scripts" / "docker-entrypoint"
    ...
    def test_entrypoint_runs_migrate(self) -> None:
        source = (Path(__file__).resolve().parent.parent.parent / "scripts" / "docker-entrypoint").read_text()
...
class TestDockerfile:
    ...
    def test_dockerfile_has_three_stages(self) -> None:
        source = (Path(__file__).resolve().parent.parent.parent / "Dockerfile").read_text()
    ...
    def test_dockerignore_exists(self) -> None:
        dockerignore = Path(__file__).resolve().parent.parent.parent / ".dockerignore"
        assert_that(dockerignore.exists(), is_(True))

    def test_dockerignore_excludes_venv(self) -> None:
        source = (Path(__file__).resolve().parent.parent.parent / ".dockerignore").read_text()
